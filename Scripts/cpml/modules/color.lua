...
function color.new(r, g, b, a)
	...
	if r and g and b then
		...
		return new(r, g, b, a or 1)

	-- {r, g, b, a}
	elseif type(r) == "table" then
		local rr, gg, bb, aa = r[1], r[2], r[3], r[4] or 1
...
function color.unpack(a, byte)
	-- for love < 0.11, or whatever else takes 0-255 instead of 0-1
	if byte then
